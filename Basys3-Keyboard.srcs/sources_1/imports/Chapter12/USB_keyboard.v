...
// Student:............. Daniel L. Tooker
// Student ID........... 660146751
...
// constant declarations
    ...
    ps2_rx ps2_rx_unit (.clk(clk), .reset(reset), .rx_en(1'b1), .PS2Data(PS2Data), .PS2Clk(PS2Clk),
                                      .rx_done_tick(scan_done_tick), .rx_data(scan_out));
/////////////////////////////////////////////////////////////////////////////////////////////////                                   
