...
always @*
	...
	if(letter_case == 1'b1)  // uppercase 
	...
	else   // lowercase // an[3] | an[2] | an[1] | an[0]
		begin
		case(scan_code)
			8'h45: ascii_code = 8'h30;   // 0led[7:0] = 8'b00001111;
		...
		8'h1c: A = 8'b1;   // a
			...
			8'h24:  A= 8'b10000;   // e
			8'h2b:  A= 8'b100000;   // f
			8'h34:  A= 8'b1000000;   // g
			8'h33:  A= 16'b10000000;   // h
			8'h43:  A= 16'b100000000;   // i
			8'h3b:  A= 16'b1000000000;   // j
			8'h42:  A= 16'b10000000000;   // k
			8'h4b:  A= 16'b100000000000;   // l
			8'h3a:  A= 16'b1000000000000;   // m
			8'h31:  A= 16'b10000000000000;   // n
			8'h44:  A= 16'b100000000000000;   // o
			8'h4d:  A= 16'b1000000000000000;   // p
